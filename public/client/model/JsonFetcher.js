class JsonFetcher {
    ...
    async getSensorData(sensor_id){
        const data = await this.get_data("/load/get_sensor_data" , {sensor_id : sensor_id})
        console.log("got limited sensor data from server " + data)
        if(data.error){
